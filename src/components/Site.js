	...
	<main>
		...
		<div class="section roadmap">
			...
			<div class="road-left">
				...
				<p class="road-p">The aim is to launch a clothing line including hoodies, t-shirts, caps etc. Alongside accessories complementing your fit or just styling items such as keyring, lanyards, mugs etc. These will be both customizable to your nft or the standard logo of Orange friends.</p>

				<h2>Phase 4: Voxel Art</h2>
				<p class="road-p">Voxel style little orange friends where it will be exclusive to people who hold the orange friend or mutated orange friend. There will be an alpha chat for the holders, allowing us to efficiently and effectively allocate the voxel orange to the current holders of the pixelated little orange friends. Will be buying land in the sandbox allowing you showcase and interact</p>
